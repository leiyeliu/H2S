...
class AVIS(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            "TRACKERS_FOLDER": "./outputs/h2s_R50_IN/inference/",
            "GT_File": "test.json",
            # Trackers location
    ...
    def __init__(self, config=None):
        ...
        if self.config["TRACKERS_TO_EVAL"] is None:
            self.tracker_list = [
                t
                for t in os.listdir(self.tracker_fol)
                if os.path.isdir(os.path.join(self.tracker_fol, t))
            ]
        else:
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        ...
        for t in range(num_timesteps):
            ...
            raw_data["raw_classes"][t] = np.atleast_1d(
                [track["category_id"] for track in tracks]
            ).astype(int)
